...
export default function ProfileCard() {
    return (
        <div className="max-w-sm mx-auto bg-background rounded-3xl shadow-lg overflow-hidden">
            {/* Profile Image */}
            ...
            <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                    ...
                    {/* Follow Button */}
                    <button className="flex items-center bg-accent hover:bg-hover transition-colors duration-200 px-4 py-2 rounded-full text-white font-medium shadow shadow-shadow cursor-pointer">
                        <span>Follow</span>
